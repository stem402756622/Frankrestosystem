-- =====================================================
-- FRANK RESTAURANT SYSTEM - COMPLETE DATABASE SCHEMA
-- =====================================================
-- This file contains the complete database structure
-- including all 30 features (12 original + 18 new)
-- 
-- Created: 2026-03-14
-- Features: Complete restaurant management system
-- =====================================================
...
-- =====================================================
-- CORE TABLES (Original 12 Features)
-- =====================================================
...
-- Reservations (Enhanced with new features)
...
-- Menu Items (Enhanced with new features)
...
-- Orders (Enhanced with new features)
...
-- =====================================================
-- NEW TABLES (18 Additional Features)
-- =====================================================
...
-- Feature 5: Peak Hours Configuration
...
-- Feature 9: Promo Codes and Discounts
...
('VIP20', 'percentage', 20.00, 100.00, 25),
('STUDENT15', 'percentage', 15.00, 30.00, 200);

-- Feature 13 & 14: Inventory Items
...
('Garlic', 'kg', 5.00, 1.00, 3.00, 'Local Produce'),
('Basil', 'bunch', 20.00, 5.00, 1.50, 'Herb Garden'),
('Parmesan Cheese', 'kg', 8.00, 2.00, 15.00, 'Italian Imports');

-- Link menu items to inventory (ingredients)
INSERT IGNORE INTO menu_item_ingredients (menu_item_id, inventory_item_id, quantity_needed) VALUES
(1, 7, 0.1), -- Bruschetta needs basil
(1, 5, 0.2), -- Bruschetta needs tomatoes
(2, 1, 0.3), -- Calamari needs chicken (placeholder)
(4, 2, 0.4), -- Steak needs beef
(5, 3, 0.3), -- Sea Bass needs salmon
(6, 4, 0.1), -- Risotto needs olive oil
(6, 1, 0.2); -- Risotto needs chicken (placeholder)
...
SELECT 'restaurant_tables' as table_name, COUNT(*) as records FROM restaurant_tables
...
UNION ALL SELECT 'peak_hours', COUNT(*) FROM peak_hours
UNION ALL SELECT 'allergens', COUNT(*) FROM allergens
UNION ALL SELECT 'reviews', COUNT(*) FROM reviews
UNION ALL SELECT 'saved_favorites', COUNT(*) FROM saved_favorites
...
--    4. Table Availability Check
--    5. Peak Hour Restrictions
--    6. Allergen & Dietary Tracking
--    7. Reviews & Ratings
--    8. Saved Favorites
...
--    14. Low Stock Alerts
--    15. Queue Management
--    16. Live Queue Display
--    17. Customer Feedback
--    18. Review Publication
--
